...
function populateActionCards() {
  return [
    ...
    },
    {
      ...
      actionText: ['Размести на поле сколько хочешь препятствий из тех, что не на поле.'],
    ...
    },
    {
      ...
      actionText: ['Размести на поле все упавшие машинки.', 'Положи их вверх ногами.'],
      imageUrl: '/src/assets/action-cards/police.jpg',
    },
    {
      title: 'Хитрец',
      artText: 'Ты подкупаешь организаторов, чтобы получить преимущество.',
      actionText: ['Запусти машинку с любой стороны.', 'Придерживайся правил стартовой области.'],
    ...
    },
    {
      ...
      actionText: [
        'Размести деревья на поле.',
        'Они должны находится в небольшом воображаемом квадрате.',
      ],
